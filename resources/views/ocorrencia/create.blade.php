					...
					<div class="row">
						...
						{{-- <div class="form-group col-md-2 col-sm-2 col-xs-12">
						 ...
						 <div class="form-group col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" id="cep" class="form-control" placeholder="CEP" name="cep" minlength="4" maxlength="100" onblur="pesquisacep(this.value);" required>
			 			</div>

						 <div class="form-group col-md-8 col-sm-8 col-xs-12">
							<label class="control-label">Bairro</label>
							<input type="text" id="bairro" class="form-control" placeholder="Bairro" name="bairro" minlength="4" maxlength="100" required
						    >
			 			</div>
					</div>
					<div class="row">
						 <div class="form-group col-md-8 col-sm-8 col-xs-12">
							...
							<input type="text" id="logradouro" class="form-control" placeholder="Logradouro" name="logradouro" minlength="4" maxlength="100" required
						    >
			 			</div>

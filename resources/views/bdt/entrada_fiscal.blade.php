...
<div class="x_panel modal-content ">
    ...
    <div class="x_panel ">
        <div class="x_content">
            ...
            @endif --}}
            <form id="frm_bdt" class="form-label-left" method="post" action="{{ url("bdtentradafiscal")  }}">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        ...
                        <input type="text" class="form-control" required="" value="{{$bdt->equipamento->numeracao}}" readonly>
                        {{-- value="{{ $bdt->veiculo->placa or old('placa') }}"> --}}
                    </div>

                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <label class="control-label col-md-1 col-sm-1 col-xs-1" for="odometro">Odometro</label>
                        <input type="number" id="ent_odometro" class="form-control" name="ent_odometro" value="{{$bdt->ent_odometro}}" readonly>
                    </div>

                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <label  for="placa">Data / Hora</label>
                        <input type="datetime-local" class="form-control" id="ent_data" name="ent_data" required="" value="{{ $bdt->ent_data }}" readonly>
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        ...
                        <textarea name="ent_observacoes" id="ent_observacoes" type="text" class="form-control" rows="3"></textarea>
                    </div>
                </div>
